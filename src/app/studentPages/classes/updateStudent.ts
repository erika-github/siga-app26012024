...
export class updateStudent {
  ...
  constructor(private updateRecordsService: UpdateRecordsService,
  ...
  updateStudent(studentDetail: StudentDetail, courseObj: Course, student: Student) {
    ...
    var spanIngre = document.getElementById('spanIngre') as HTMLSpanElement;


    if (courseObj.id === "") {

      student.cursoAnnio = studentDetail.curso.annio;
      student.cursoSeccion = studentDetail.curso.seccion;
      student.cursoPeriodoAcademico = studentDetail.curso.periodoAcademico;

      student.cursoTurno = studentDetail.curso.turno;
      student.cursoNivel = studentDetail.curso.nivel;
    ...
    console.log('0).-studentDetail.id:::' + studentDetail.id);
    ...
    if (studentDetail.tipoDocumento !== "default" &&
      ...
      spanIngre.innerHTML != 'El campo ingresos mensuales es inválido. Sólo puede admitir números'

    ) {



      this.updateRecordsService.updateStudent(student)
