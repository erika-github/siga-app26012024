...
import { CreateTeacherRecordsService } from "../services/createTeacherRecords.service";
...
@Injectable({
  ...
  export class CreateTeacher {  
    ...
    private createTeacherRecordsService:CreateTeacherRecordsService ){

    }    
   

    createTeacher(teacherDetail:TeacherDetail){  
    ...
    spanAsigEspe.innerHTML != 'Este campo posee caracteres inválidos'
      ...
      this.createTeacherRecordsService.createTeacher(teacherDetail)
